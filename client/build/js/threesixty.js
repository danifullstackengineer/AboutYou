...
$(document).on("clicked360", (ev) => {
	...
	var ready = false,
			...
			$document = $(document),
			$container = $('#product360__threesixty'),
			$images = $('#product360__threesixty_images'),
	...
	*/
	function addSpinner () {
		spinner = new CanvasLoader("product360__spinner");
		...
		$("#product360__spinner").fadeIn("slow");
	};
	...
	*/
	function loadImage() {
		...
		var imageName = ev.originalEvent.detail  + (loadedImages + 1) + ".jpg";
		/*
		...
		*/
		var image = $('<img>').attr('src', imageName).addClass("product360__prevImg").appendTo(li);
	...
	*/
	function imageLoaded() {
		...
		$("#product360__spinner span").text(Math.floor(loadedImages / totalFrames * 100) + "%");
		...
		if (loadedImages == totalFrames) {
			...
			frames[0].removeClass("product360__prevImg").addClass("product360__nextImg");
			/*
			...
			*/
			$("#product360__spinner").fadeOut("slow", function(){
				spinner.hide();
				showThreesixty();
			});
		} else {
	...
	*/
	function hidePreviousFrame() {
		...
		*/
		frames[getNormalizedCurrentFrame()].removeClass("product360__nextImg").addClass("product360__prevImg");
	};
	...
	*/
	function showCurrentFrame() {
		/*
			...
			It calls the "getNormalizedCurrentFrame" method to translate the "currentFrame" value to the "totalFrames" range (1-180 by default).
		*/
		frames[getNormalizedCurrentFrame()].removeClass("product360__prevImg").addClass("product360__nextImg");
	};
