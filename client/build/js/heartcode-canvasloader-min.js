(function (w) {
  var k = function (b, c) {
    ...
    o,
    p = ["canvas", "vml"],
    i = ["oval", "spiral", "square", "rect", "roundRect"],
  ...
  a.init = function (b, c) {
    ...
    try {
      this.mum =
        document.getElementById(b) !== void 0
    ...
    if (y)
      (o = p[0]),
        ...
        (this.cCan = m(n("canvas", this.cont), { visibility: "hidden" })),
  ...
  a.setDensity = function (b) {
    this.density =
      q && o === p[1]
        ? Math.round(Math.abs(b)) <= 40
          ? Math.round(Math.abs(b))
          : 40
        : Math.round(Math.abs(b));
  ...
  a.draw = function () {
    ...
    if (o === p[0]) {
      ...
      t(this.can, { width: f, height: f });
      for (t(this.cCan, { width: f, height: f }); b < r; ) {
        l = b <= s ? 1 - (1 / s) * b : (l = 0);
        k = 360 - (360 / r) * b;
        j = (k / 180) * Math.PI;
        h.fillStyle =
        ...
        switch (this.shape) {
          ...
          case i[1]:
            ...
            h.beginPath();
            this.shape === i[1]
              ? h.arc(f * 0.5 + e, f * 0.5 + g, c * l, 0, Math.PI * 2, false)
              : h.arc(f * 0.5 + e, f * 0.5 + g, c, 0, Math.PI * 2, false);
            break;
          case i[2]:
            c = f * 0.12;
            e = Math.cos(j) * (f * 0.47 - c) + f * 0.5;
            g = Math.sin(j) * (f * 0.47 - c) + f * 0.5;
            u(h, e, g, j);
            ...
            (a = f * 0.3),
              ...
              this.shape === i[3]
                ...
                : ((c = d * 0.55),
                  ...
                  h.quadraticCurveTo(e, g - d * 0.5, e + c, g - d * 0.5));
        }
        h.closePath();
        h.fill();
        h.restore();
      ...
      m(this.cont, { width: f, height: f });
      m(this.vml, { width: f, height: f });
      switch (this.shape) {
        case i[0]:
        case i[1]:
          j = "oval";
      ...
      for (g = -d * 0.5; b < r; ) {
        ...
        switch (this.shape) {
          ...
          case i[0]:
          case i[2]:
            v && ((g = 0), this.shape === i[2] && (e = 500 - d * 0.5));
            break;
          case i[3]:
          case i[4]:
            (a = c * 0.95),
        ...
        h = t(
          m(n("group", this.vml), { width: 1e3, height: 1e3, rotation: k }),
          { coordsize: "1000,1000", coordorigin: "-500,-500" }
        );
        h = m(n(j, h, { stroked: false, arcSize: q }), {
          width: a,
          height: d,
          top: g,
          left: e,
        });
        n("fill", h, { color: this.color, opacity: l });
        ++b;
      }
    }
    this.tick();
  ...
  a.tick = function () {
    ...
    o === p[0]
      ...
      : (this.activeId >= 360 && (this.activeId -= 360),
        m(this.vml, { rotation: this.activeId }));
  };
  a.show = function () {
    if (typeof this.timer !== "number") {
      ...
      m(this.cont, { visibility: "visible" });
    }
  };
  a.hide = function () {
    typeof this.timer === "number" &&
  ...
  a.kill = function () {
    ...
    o === p[0]
      ? (a.removeChild(this.can), a.removeChild(this.cCan))
